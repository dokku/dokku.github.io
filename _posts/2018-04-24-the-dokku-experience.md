...
While we have a cli aimed at humans, as developers, we yearn for interfaces computers cann automate. Our next blog post will cover how developers may interact with Dokku in a declarative fashion in order to ensure that their servers and applications are configured as expected.